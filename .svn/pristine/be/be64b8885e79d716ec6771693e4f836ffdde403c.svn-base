                ...
                for (OrderHangDto orderHangDto : orderHangDtoList) {
                    ...
                    button.setOnAction(event -> {
                      for(ObservableList<PosOrder> posOrders :main.getHangOrderBoxs()){
                          if(orderHangDto.getBillNo().equals(posOrders.get(0).getBill_no())){
                                  ...
                                  main.setHangRefNum(posOrders.get(0).getBill_no());
                          }
                      }
                        stage.close();
                    });
