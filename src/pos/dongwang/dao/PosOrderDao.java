...
public  class PosOrderDao {
    ...
    public static synchronized Map<String, List<PosOrderDto>> getPosOrderList(List<String> print_info, String timeInterval,Date date) {
      /*  String sql = "select\n" +
                "  rd.bill_no,\n" +
                "  rd.sub_no,\n" +
                "  rd.type,\n" +
...
//                               .reversed()).forEachOrdered(e -> finalMap.put(e.getKey(), e.getValue()));
    ...
    public static synchronized   Map<String, List<PosOrderDto>> getPosOrderListInit(List<String> print_info, String timeInterval,Date date) {
      /*  String sql = "select\n" +
                "  rd.bill_no,\n" +
                "  rd.sub_no,\n" +
                "  rd.type,\n" +
...
//                              .reversed()).forEachOrdered(e -> finalMap.put(e.getKey(), e.getValue()));
    ...
    public static  synchronized Map<String, List<PosOrderDto>> getHangPosOrderList(List<String> print_info,String timeInterval,Date date) {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        Map<String, Object> map = new HashMap<>();
        map.put("printers", print_info);
        map.put("timeInterval",timeInterval);
    ...
    public  static String  checkBilled(String bill_no, String type, String sub_no){
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        return sqlSession.getMapper(PosOrderDtoMapper.class).checkBilled(bill_no,type,sub_no);
    }
